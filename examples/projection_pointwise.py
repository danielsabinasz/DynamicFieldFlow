...
from dfpy import connect, GaussInput, Field, Sigmoid
from dfpy.dimension import Dimension
from dfpy.weight_patterns import GaussWeightPattern
...
connect(gauss, field, pointwise_weights=[5.0]*25+[0.0]*26, activation_function=Sigmoid(beta=1))
