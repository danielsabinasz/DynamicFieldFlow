...
for height in np.arange(3.24, 4.00, 0.01, dtype=np.float32):
    ...
    def loss():
        ...
        total_loss = before_boost_loss + selective_peak
        tf.print(before_boost_loss, selective_peak)
    ...
    with open('out.txt', 'a') as f:
        f.write(str(height) + " " + str(n_left) + " " + str(n_right) + " " + str(n_both) + " " + str(n_none) + "\n")
    print()
